...
import { StyledTableContainerAnimated } from './styles';
import { renderHeader } from './tableConfig';
import TableFooter from './TableFooter';

interface CoreTableDemoProps {
	type: TableType;
	isLoading?: boolean;
...
const CoreTableDemo = ({
	...
	return (
		<>
			<StyledTableContainerAnimated component={Paper} elevation={0}>
				{/* <CoreScrollbar> */}
