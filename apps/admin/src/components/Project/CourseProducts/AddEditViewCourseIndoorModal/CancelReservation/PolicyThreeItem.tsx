...
const PolicyThreeItem: React.FC<Props> = ({
	id = 'free-change',
	beforeDay = '',
	onBeforeDayChange,
	...
	return (
		<Components.Row>
			...
			<Components.StyledCell width='430px'>可免費更改時段，以 1 次為限。</Components.StyledCell>
			<Components.StyledCell width='60px'>{/* No remove button for free change policy */}</Components.StyledCell>
		</Components.Row>
	);
};

export default PolicyThreeItem;
