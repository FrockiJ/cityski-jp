	...
	return (
		...
		>
			<StyledSearchFilterWrapper>
				<CoreFilter
					tableId={configReservationsOverseasTable.tableId}
					tableDataCount={0}
			...
			<CoreDynamicTable
				id={configReservationsOverseasTable.tableId}
				headData={configReservationsOverseasTable.columns}
				dataCount={0}
				isLoading={false}
			>
				<CoreDynamicTableList<ReservationOverseasTableListResult>
					rows={[]}
					tableConfig={configReservationsOverseasTable}
...
export default OverseasLessonPage;
